package org.quickstart.junit.example3;

/**
 * A very basic program that demonstrates the use of JUnit tests. The tests include a sample unit test and an integration test.
 */
    ...
    public static void main(String[] args) {
        ...
        if (args.length >= 1) {
            try {
                ...
                System.err.println("I don't understand the parameter you passed me. Is it a number? " + "Parameter was: [" + args[0] + "]");
